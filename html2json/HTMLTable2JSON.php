...
class HTMLTable2JSON {
	...
	public function tableToJSON($url, $firstColIsRowName = TRUE, $tableID = '', $ignoreCols = NULL, $headers = NULL, $firstRowIsData = FALSE, $onlyColumns = FALSE, $arrangeByRow = FALSE, $ignoreHidden = FALSE, $printJSON = FALSE, $testingTable = NULL) {
		$ignoring = FALSE;
		$excluding = FALSE;
		if (NULL != $onlyColumns){
